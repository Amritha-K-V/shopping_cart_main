...
import 'package:shopping_cart_main/view/product_details_screen/product_details_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:homeScreenProvider.isLoading?Center(
      ...
      : Column( 
        children: [
                  ...
                  (index) => Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: homeScreenProvider.selectedcategoryIndex ==
                                    index
                                ? Colors.black
                                : Colors.grey.withOpacity(.2),
                            borderRadius: BorderRadius.circular(10)),
                        child: Text(
                          homeScreenProvider.categoriesList[index].toString(),
                          style: TextStyle(
          ...
          Expanded(
              ...
              child: homeScreenProvider.isProductsLoading ?Center(
                child: CircularProgressIndicator(),
              )
            ...
            itemBuilder: (context, index) => InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ProductDetailsScreen(productId: homeScreenProvider.product[index].id.toString(),),
                    ));
              },
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(
                              homeScreenProvider.product[index].image.toString()
                                ))),
                  ...
                  Text(
                    maxLines: 1,
                                                  homeScreenProvider.product[index].title.toString()
,
                    style: TextStyle(
                        color: Colors.black,
                  ...
                  Text(                              homeScreenProvider.product[index].price.toString()
),
                ],
              ),
            ),
